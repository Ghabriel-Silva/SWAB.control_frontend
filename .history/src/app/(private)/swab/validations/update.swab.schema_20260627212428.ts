    ...
    sameFaucetJustification: yup
        ...
        .test(
            ...
            function (value) {
                ...
                // Só obrigatório se a torneira for igual à última
                const isRequired =
                    context?.lastFaucetLocation &&
                    faucetCode === context.lastFaucetLocation

                if (!isRequired) return true // não precisa, passa livre

                return (value?.trim().length ?? 0) > 0 // obrigatório ter conteúdo
            }
        ),
    ...
    updateSwabJustification: yup
        ...
        .test(
            ...
            function (value) {
                ...
                // Só obrigatório se o tipo original era ATP/MICRO e agora mudou pra VISUAL
                const isRequired =
                    context?.typeSwabBD &&
