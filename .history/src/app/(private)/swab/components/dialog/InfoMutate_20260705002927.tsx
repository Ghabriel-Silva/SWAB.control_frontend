...
export const InfoMutate = ({ swab }: SwabDataProps) => {
    const methods = useForm({
        ...
        defaultValues: {
            ...
            valueAtp: !swab.check.valueAtp ? undefined : swab.check.valueAtp,4 observation: swab.check.oberservation: !swab.check.oberservation ? swab.check.oberservation : swab.check.oberservation  ,
        }
    })
