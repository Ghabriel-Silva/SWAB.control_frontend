...
export const InfoMutate = ({ swab }: SwabDataProps) => {
    const methods = useForm({
        ...
        defaultValues: {
            ...
            batch: !swab.batch ? undefined : swab.batch,
            valueAtp: !swab.check.valueAtp ? undefined : swab.check.valueAtp,
    ...
    useEffect(() => {
        if (isVisual) {
            ...
            setValue('batch', isNullOrUndefined, { shouldValidate: true })
        }
    }, [isVisual, resetField, setValue])
