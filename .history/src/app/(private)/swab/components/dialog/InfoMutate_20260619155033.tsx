...
export const InfoMutate = ({ swab }: SwabDataProps) => {
    ...
    //fazer um verificação entre lastfaucet e a torneira que esta entrando
    ...
    useEffect(() => {
        if (isSameFaucet) {
            setError("faucetCode", {
                type: '',
                message: 'Defina um justificativa pra utilizar a mesma torneira'
            })

        } else {
            clearErrors('faucetCode')
        }
    }, [isSameFaucet, setError, clearErrors])
