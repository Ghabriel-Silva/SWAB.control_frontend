...
import { Calendar, ResultSelect, SameFauceteJustification, TypeSwabSelect } from "@/app/(private)/swab/components/index";
                ...
                >
                    ...
                    >
                        <HStack>
                            ...
                            {isSameFaucet && (
                                <FormField label="mesma torneira" error={errors.sameFaucetJustification?.message}>
