...
export const InfoMutate = ({ swab }: SwabDataProps) => {
    ...
    //Se a torneira for igual a  ultima utiliza retorne true para rederiza o componente justification se a torneira é diferente da ultima torneira(por exemplo o usuário mudou a torneira) e eu tenho uma justificativa 
