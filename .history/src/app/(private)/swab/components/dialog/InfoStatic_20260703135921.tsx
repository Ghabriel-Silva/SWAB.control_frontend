...
export const InfoStatic = ({ swab }: SwabDataProps) => {
    return (
        ...
        >
            ...
            <FormField label="Justificativa de mudança de Swab">
                <BodyText>{swab.check.updateSwabJustification} </BodyText>
            </FormField>
            <FormField label="Justificativa mesma torneira">
                <BodyText>{swab.check.sameFaucetJustification} </BodyText>
            </FormField>
        </SimpleGrid>
    )
}