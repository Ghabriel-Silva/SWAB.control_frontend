...
import { Calendar, OperatorSelect, ResultSelect, Justification, TypeSwabSelect, ContainerInputs } from "@/app/(private)/swab/components/index";
        ...
        <FormProvider {...methods}>
            <form onSubmit={handleSubmit(OnSubmit)} noValidate>
                ...
                >
                    ...
                    <ContainerInputs hasJustification={fasle} >
                        <Input size={"xs"} placeholder="ex: 22" {...register('faucetCode')} />
                    </ContainerInputs>
