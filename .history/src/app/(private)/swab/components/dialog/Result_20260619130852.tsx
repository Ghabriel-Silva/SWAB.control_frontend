...
export const ResultSelect = () => {
    ...
    const { control, getValues } = useFormContext<UpdateSwabType>()

    const valueResult = getValues()
    const [vResult, setVResult] = useState(valueResult.result)
