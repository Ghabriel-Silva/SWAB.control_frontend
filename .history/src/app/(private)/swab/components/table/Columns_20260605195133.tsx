...
import { NewFaucet, TypeSwab, Calendar, OperatorSelect, Result, ValueAtp } from "@/app/(private)/swab/components/index";
...
export const columns: GridColDef<SwabGridRow>[] = [
    ...
    },
    {
        ...
        flex: 1,
        minWidth: 120,
        renderCell: (params: GridRenderCellParams<SwabGridRow, SwabCheckType>) => {3
            return (
