...
import { StatEmpaty } from "@/app/(private)/components";
...
export function SwabTable({ rows, loading, dataMeta }: Props) {
    ...
    const NoRowsOverlay = () => <StatEmpaty title="Nenhum pendente" description="" />
    ...
    return (
        ...
        >
            <DataGrid
                ...
                slots={{
                    noRowsOverlay:
                            <StatEmpaty title="Nenhum pendente" description="" />
                }}
            />
        </div>
    );
