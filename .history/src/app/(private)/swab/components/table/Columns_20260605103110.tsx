...
import { NewFaucet, LastFaucet, Calendar, OperatorSelect, Result, ValueAtp } from "@/app/(private)/swab/components/index";
...
export const columns: GridColDef<SwabGridRow>[] = [
    ...
    },
    {
        ...
        flex: 1.5,
        minWidth: 150,
        renderCell: (params:GridRenderCellParams<SwabGridRow, >) => {
