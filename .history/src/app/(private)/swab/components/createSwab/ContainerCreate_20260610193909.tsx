        ...
        mutate({
        ...
        },
            {
                onSuccess: (data) => {
                    ...
                    if (pendente.length || invalidos.length) {
                        let title = '';
                        let description = '';

                        if (pendente.length && invalidos.length) {
                            title = 'Pendentes e inválidos';
                            description =
                                `Swab(s) ${pendente.join(', ')} constam como pendentes no sistema. ` +
                                `${invalidos.join(', ')} não estão cadastrados no sistema.`;
                        } else if (pendente.length) {
                            title = 'Pendente';
                            description =
                                `Swab(s) ${pendente.join(', ')} constam como pendentes no sistema.`;
                        } else {
