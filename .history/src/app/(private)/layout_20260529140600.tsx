        ...
        <Box height={"100vh"} width={"100vw"} >
            <Flex flexDirection={"row"}>
                <Box
                    ...
                    flexShrink={0}
                >
                    <VStack w={"250px"} bg={"green"} py={2} align={"start"}>
                        <HStack  bg={"blue"} w={"100%"}>
                            <Image
                                src={iconSwab}
                            ...
                            <VStack align={"start"} bg={"red"}>
                                <Text color={"white"} fontSize={"16px"} fontWeight={""}>SwabControl</Text>
                                <Text color={"white"}> Sitema de Swabs</Text>
                            </VStack>
                        </HStack>
                    </VStack>
                </Box>
